...
VERA_RUBIN_SUPPLY_CHAIN = [
    ...
    {"category": "CPO/矽光子", "company": "TSMC 台積電", "ticker": "2330.TW", "role": "silicon photonics / COUPE-style advanced optical packaging exposure", "source": "NVIDIA CPO technical blog"},
    {"category": "CPO/矽光子", "company": "ASE 日月光投控", "ticker": "3711.TW", "role": "SPIL chip-scale packaging, optical validation and test exposure", "source": "NVIDIA on-demand / industry reports"},
    {"category": "CPO/矽光子", "company": "Lumentum", "ticker": "LITE", "role": "external laser source / high-power laser exposure for CPO", "source": "NVIDIA CPO ecosystem"},
    {"category": "CPO/矽光子", "company": "Coherent", "ticker": "COHR", "role": "laser, optical component and external laser source exposure", "source": "NVIDIA CPO ecosystem"},
    {"category": "CPO/矽光子", "company": "Fabrinet", "ticker": "FN", "role": "optical module and precision manufacturing exposure", "source": "NVIDIA CPO ecosystem"},
    {"category": "CPO/矽光子", "company": "Corning", "ticker": "GLW", "role": "fiber, glass and optical connectivity exposure", "source": "NVIDIA manufacturing ecosystem"},
    {"category": "光通訊/光纖連接", "company": "Browave 波若威", "ticker": "3163.TWO", "role": "fiber connection / optical interconnect watchlist", "source": "industry reports"},
    {"category": "光通訊/光纖連接", "company": "PCL 上詮", "ticker": "3363.TWO", "role": "fiber array / optical passive component watchlist", "source": "industry watchlist"},
    {"category": "光通訊/光纖連接", "company": "SENKO", "ticker": "", "role": "fiber connector / optical interconnect ecosystem", "source": "NVIDIA CPO ecosystem"},
    {"category": "光通訊/光收發", "company": "SENKO Advanced Components", "ticker": "", "role": "high-density optical connector ecosystem", "source": "NVIDIA CPO ecosystem"},
    {"category": "光通訊/光收發", "company": "LandMark Optoelectronics 聯亞", "ticker": "3081.TWO", "role": "InP laser / optical component watchlist", "source": "industry watchlist"},
    {"category": "光通訊/光收發", "company": "Visual Photonics 華星光", "ticker": "4979.TWO", "role": "optical transceiver / laser component watchlist", "source": "industry watchlist"},
    {"category": "光通訊/材料", "company": "AXT", "ticker": "AXTI", "role": "compound semiconductor substrate / InP wafer exposure", "source": "industry reports"},
    {"category": "光通訊/材料", "company": "Sumitomo Electric", "ticker": "5802.T", "role": "fiber, optical cable and compound semiconductor material exposure", "source": "industry reports"},
    {"category": "NPO/CPO過渡", "company": "Broadcom", "ticker": "AVGO", "role": "switch ASIC, SerDes and custom silicon exposure", "source": "industry reports"},
    {"category": "NPO/CPO過渡", "company": "Marvell", "ticker": "MRVL", "role": "SerDes, DSP, electro-optical interconnect and custom silicon exposure", "source": "industry reports"},
    {"category": "NPO/CPO過渡", "company": "Credo", "ticker": "CRDO", "role": "AEC, retimer/DSP and high-speed connectivity transition exposure", "source": "industry watchlist"},
    {"category": "NPO/CPO過渡", "company": "Astera Labs", "ticker": "ALAB", "role": "PCIe/CXL connectivity and retimer exposure", "source": "industry watchlist"},
    {"category": "OCS/光交換", "company": "Cisco", "ticker": "CSCO", "role": "optical/networking system and switching exposure", "source": "industry watchlist"},
    {"category": "OCS/光交換", "company": "Arista Networks", "ticker": "ANET", "role": "AI data center Ethernet switching exposure", "source": "industry watchlist"},
    {"category": "OCS/光交換", "company": "Broadcom", "ticker": "AVGO", "role": "Tomahawk / Jericho-class switching ASIC exposure", "source": "industry watchlist"},
    {"category": "OCS/光交換", "company": "Celestial AI", "ticker": "", "role": "photonic fabric / optical interconnect private-company watchlist", "source": "industry watchlist"},
    {"category": "先進封裝/CoWoS", "company": "TSMC 台積電", "ticker": "2330.TW", "role": "CoWoS / advanced packaging capacity bottleneck", "source": "industry reports"},
    {"category": "先進封裝/CoWoS", "company": "Amkor", "ticker": "AMKR", "role": "advanced packaging and test partner for next-generation AI infrastructure", "source": "Amkor official"},
    ...
    {"category": "800V HVDC/電源半導體", "company": "Texas Instruments", "ticker": "TXN", "role": "power management silicon ecosystem", "source": "NVIDIA 800 VDC official"},
...
CSP_SUPPLY_CHAIN = [
    ...
    {"csp": "Cross-CSP infrastructure", "category": "CPO/矽光子", "company": "TSMC 台積電", "ticker": "2330.TW", "role": "silicon photonics / advanced optical package manufacturing exposure", "source": "NVIDIA CPO technical blog"},
    {"csp": "Cross-CSP infrastructure", "category": "CPO/矽光子", "company": "ASE 日月光投控", "ticker": "3711.TW", "role": "SPIL optical package, validation and test exposure", "source": "NVIDIA on-demand / industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "CPO/矽光子", "company": "Lumentum", "ticker": "LITE", "role": "external laser source / high-power laser exposure", "source": "NVIDIA CPO ecosystem"},
    {"csp": "Cross-CSP infrastructure", "category": "CPO/矽光子", "company": "Coherent", "ticker": "COHR", "role": "laser, optical component and external laser source exposure", "source": "NVIDIA CPO ecosystem"},
    {"csp": "Cross-CSP infrastructure", "category": "CPO/矽光子", "company": "Fabrinet", "ticker": "FN", "role": "optical manufacturing and system integration exposure", "source": "NVIDIA CPO ecosystem"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/光纖連接", "company": "Corning", "ticker": "GLW", "role": "fiber, glass and optical connectivity exposure", "source": "NVIDIA manufacturing ecosystem"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/光纖連接", "company": "Browave 波若威", "ticker": "3163.TWO", "role": "fiber connection / optical interconnect watchlist", "source": "industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/光纖連接", "company": "PCL 上詮", "ticker": "3363.TWO", "role": "fiber array / optical passive component watchlist", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/光收發", "company": "LandMark Optoelectronics 聯亞", "ticker": "3081.TWO", "role": "InP laser / optical component watchlist", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/光收發", "company": "Visual Photonics 華星光", "ticker": "4979.TWO", "role": "optical transceiver / laser component watchlist", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/材料", "company": "AXT", "ticker": "AXTI", "role": "compound semiconductor substrate / InP wafer exposure", "source": "industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "光通訊/材料", "company": "Sumitomo Electric", "ticker": "5802.T", "role": "fiber, optical cable and compound semiconductor material exposure", "source": "industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "NPO/CPO過渡", "company": "Broadcom", "ticker": "AVGO", "role": "switch ASIC, SerDes and custom silicon exposure", "source": "industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "NPO/CPO過渡", "company": "Marvell", "ticker": "MRVL", "role": "SerDes, DSP, electro-optical interconnect and custom silicon exposure", "source": "industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "NPO/CPO過渡", "company": "Credo", "ticker": "CRDO", "role": "AEC, retimer/DSP and high-speed connectivity transition exposure", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "NPO/CPO過渡", "company": "Astera Labs", "ticker": "ALAB", "role": "PCIe/CXL connectivity and retimer exposure", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "OCS/光交換", "company": "Cisco", "ticker": "CSCO", "role": "optical/networking system and switching exposure", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "OCS/光交換", "company": "Arista Networks", "ticker": "ANET", "role": "AI data center Ethernet switching exposure", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "OCS/光交換", "company": "Broadcom", "ticker": "AVGO", "role": "high-radix switching ASIC exposure", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "OCS/光交換", "company": "Celestial AI", "ticker": "", "role": "photonic fabric / optical interconnect private-company watchlist", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "先進封裝/CoWoS", "company": "TSMC 台積電", "ticker": "2330.TW", "role": "CoWoS / advanced packaging capacity bottleneck", "source": "industry reports"},
    {"csp": "Cross-CSP infrastructure", "category": "先進封裝/CoWoS", "company": "Amkor", "ticker": "AMKR", "role": "advanced packaging and test partner for next-generation AI infrastructure", "source": "Amkor official"},
    {"csp": "Cross-CSP infrastructure", "category": "先進封裝/材料", "company": "Kinsus 景碩", "ticker": "3189.TW", "role": "ABF substrate / AI package substrate exposure", "source": "industry watchlist"},
    {"csp": "Cross-CSP infrastructure", "category": "先進封裝/材料", "company": "Unimicron 欣興", "ticker": "3037.TW", "role": "ABF substrate / HDI substrate exposure", "source": "industry watchlist"},
    ...
    {"csp": "Cross-CSP infrastructure", "category": "800V HVDC/電源半導體", "company": "Texas Instruments", "ticker": "TXN", "role": "power management silicon ecosystem", "source": "NVIDIA 800 VDC official"},
...
TSMC_SUPPLY_CHAIN = [
    ...
    {"technology_node": "CoWoS", "category": "載板/ABF", "company": "Ibiden", "ticker": "4062.T", "role": "advanced package substrate exposure", "source": "user watchlist"},
    ...
    {"technology_node": "CoWoS", "category": "載板/PCB", "company": "ZDT 臻鼎-KY", "ticker": "4958.TW", "role": "advanced PCB / IC substrate watchlist", "source": "ZDT official / user watchlist"},
